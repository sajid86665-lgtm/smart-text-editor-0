...
showEditor = function(initTitle, initContent)
  ...
  local function removeContactInfo()
    ...
    local items = {}
    for _, p in ipairs(phones) do table.insert(items, "馃摓 " .. p) end
    for _, e in ipairs(emails) do table.insert(items, "鉁夛笍 " .. e) end
  ...
  local topBar = {
    ...
    { Button, id="btn_menu", text="MENU", textSize="16sp", textColor=0xFFFFFFFF, backgroundColor=Color.TRANSPARENT, padding="5dp" }
  }
